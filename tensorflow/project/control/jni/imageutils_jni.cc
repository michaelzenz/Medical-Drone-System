...
#include "tensorflow/project/control/jni/rgb2yuv.h"
#include "tensorflow/project/control/jni/yuv2rgb.h"
...
#define IMAGEUTILS_METHOD(METHOD_NAME) \
  Java_com_airlife_control_env_ImageUtils_##METHOD_NAME  // NOLINT
...
JNIEXPORT void JNICALL
IMAGEUTILS_METHOD(convertRGBAToARGB8888)(
    JNIEnv* env, jclass clazz, jbyteArray input, jintArray output,
    jint width, jint height);

JNIEXPORT void JNICALL
IMAGEUTILS_METHOD(convertRGBAToLUMINANCE)(
    JNIEnv* env, jclass clazz, jbyteArray input, jbyteArray output,
    jint width, jint height);
...
IMAGEUTILS_METHOD(convertRGBAToARGB8888)(
  ...
  ConvertRGBAToARGB8888(reinterpret_cast<uint8_t*>(i),
                                  reinterpret_cast<uint32_t*>(o), width,
                                  height);
...
IMAGEUTILS_METHOD(convertRGBAToLUMINANCE)(
  ...
  ConvertRGBAToLUMINANCE(reinterpret_cast<uint8_t*>(i),
                                  reinterpret_cast<uint8_t*>(o), width,
                                  height);
