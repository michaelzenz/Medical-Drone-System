...
public class AutoController implements ServerConnection.onResponseReadyListener{

    private static ServerConnection connection=null;
    private MainControlActivity mMissionRunner=null;
    ...
    public AutoController(MainControlActivity missionRunner)
    {
