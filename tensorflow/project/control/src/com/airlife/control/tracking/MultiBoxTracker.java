...
package com.airlife.control.tracking;
...
import com.airlife.control.Classifier.Recognition;
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    frameToCanvasMatrix =
        ImageUtils.getTransformationMatrix(
            ...
            sensorOrientation,//here add 90 to degree
            false);
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString);//here set it to top
    }
  }
