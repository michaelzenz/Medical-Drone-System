...
import com.airlife.control.env.SplitTimer;
...
public class TensorFlowYolov2Detector implements Classifier {
  ...
  public static Classifier create(
      ...
      final int blockSize) {
    TensorFlowYolov2Detector d = new TensorFlowYolov2Detector();
  ...
  private TensorFlowYolov2Detector() {}
