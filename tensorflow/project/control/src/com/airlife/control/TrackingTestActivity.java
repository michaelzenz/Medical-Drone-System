...
public class TrackingTestActivity extends BaseActivity implements OnClickListener, OnTouchListener, CompoundButton.OnCheckedChangeListener, ActiveTrackMissionOperatorListener {

    private AutoTestController controller=null;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_start:
                if (null == controller) {
                    controller = new AutoTestController(this);
                }
